...
`goods_sn`  varchar(10) NOT NULL COMMENT '商品编号' ,
`market_price`  decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '市场价' ,
`shop_price`  decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT '商城价格' ,
`goods_sales`  mediumint(8) NOT NULL DEFAULT 0 COMMENT '商品销量' ,
`goods_number`  mediumint(8) NOT NULL COMMENT '商品库存' ,
`goods_img`  varchar(255) NOT NULL COMMENT '图片路径' ,
`goods_img_small`  varchar(255) NOT NULL COMMENT '图片缩略图路径' ,
